...
class Filter:
    ...
    async def _fetch_user_vault(self, user_id: str) -> Dict[str, str]:
        """
        ...
        try:
            ...
            tool_obj = OWUITools.get_tool_by_id(tool_id)
    ...
    async def _fetch_model_system_prompt(self, model_id: str) -> str:
        """
    ...
    async def inlet(
        ...
        vault = await self._fetch_user_vault(user_id)
        ...
        admin_system_raw = await self._fetch_model_system_prompt(model_id)
